...
#include "image/wci_color_space_in.h"
...
{
  wci_memset( arSize, 0, MAX_IMAGE_COMPONENTS*sizeof(SIZE) );
...
)
{
  ...
  wci_memset( prImage, 0, sizeof(IMAGE_EX) );
}
...
)
{
  ...
  wci_memset( prImage, 0, sizeof(DIFF_IMAGE_EX) );
}
